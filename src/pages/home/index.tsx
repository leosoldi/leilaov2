    ...
    <div>
      ...
      <Container>
        <div className="flex justify-center items-center mb-5 mt-3 text-2xl md:text-4xl font-bold">
          <span className="text-center" style={{ color: '#3131a4' }}>Leilões Finalizados</span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            ...
            <div className="rounded-lg bg-white p-5 shadow-2xl flex flex-col items-center relative cursor-not-allowed">
              ...
              <div className="w-32 h-32 sm:w-40 sm:h-40 relative">
                ...
                <div className="absolute left-0 transform -translate-x-1/3 -translate-y-1/3 text-white px-3 py-1 text-base font-bold rounded-full flex items-center space-x-2" style={{ background: 'linear-gradient(90deg, rgba(58, 51, 176) 20%, rgba(136, 132, 224) 70%, rgba(58, 51, 176) 100%)' }} >
              ...
              <div className="relative w-full h-6 bg-transparent rounded-full border border-black">
                <div className="absolute top-0 left-0 h-full bg-blue-500 rounded-full text-white flex items-center justify-center" style={{width: '100%', background: 'linear-gradient(94deg, rgba(101,101,101,1) 0%, rgba(131,133,143,0.67) 100%)'}}>
                  100%
                </div>
              </div>
          ...
          {activeProducts.map(product => (
            <div key={product.id} className="rounded-lg bg-white p-5 shadow-2xl flex flex-col items-center relative duration-300 ease-in-out transform hover:scale-105">
              <div className="inline-block w-full rounded-xl text-center text-white" style={{ background: 'linear-gradient(90deg, rgba(58, 51, 176) 20%, rgba(136, 132, 224) 100%, rgba(210,92,223,1) 100%)' }}>
                <p className="text-xs font-semibold">Começa em</p>
                <div className="font-mono text-lg">
                  <span>04d</span> <span>12h</span> <span>13m</span> <span>50s</span>
                </div>
              ...
              <div className="relative w-full h-6 bg-transparent rounded-full border border-black">
                <div className="absolute top-0 left-0 h-full rounded-full text-white flex items-center justify-center" style={{ width: '80%', background: 'linear-gradient(90deg, rgba(58, 51, 176) 20%, rgba(136, 132, 224) 100%, rgba(210,92,223,1) 100%)' }}>
                  80%
                </div>
              </div>
              <button
                    className="w-full h-12 mt-3 rounded-full text-lg font-bold bg-gradient-to-r text-white shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105 flex items-center justify-center" style={{ background: 'linear-gradient(90deg, rgba(58, 51, 176) 20%, rgba(136, 132, 224) 70%, rgba(58, 51, 176) 100%)' }} 
                  >
                    PARTICIPE
                    <HiFire className="ml-2" color='red' size={25} />
                  </button>
            </div>
          ))}
        </div>
